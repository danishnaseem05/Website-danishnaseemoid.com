<?php
    ...
    $project_cards = array(array('Python', 'fab fa-python', 'Web Server', 'Web Server created using sockets in python, runs on localhost:8000 by default, and accepts multiple clients. Saves the html file by keeping the directory structure inside a custom created folder called \'static\', only if the response was a HTTP 200 OK response; otherwise checks for 404 Not Found, and 400 Bad Request errors.', '../pics/project_cards/Web_Server/Capture5.PNG', 'https://github.com/danishnaseem05/WebServer'),
                        array('Java', 'fab fa-java', 'Sorted Doubly Linked List', 'This is the GUI representation of my customly implemented Doubly Linked List. This List is Sorted and only allows unique integer values. Furthermore, the GUI is easily navigable and its purpose is to Add an unique integer while keeping the list sorted, Delete an integer if it exists in the list, and Display All integers currently stored within the list. Adding to and displaying an empty list, deleting an unstored integer, or entering a non-integer value; all would display errors.', '../pics/project_cards/Doubly_Linked_Sorted_List/Capture5.PNG', 'https://github.com/danishnaseem05/Doubly-Linked-Sorted-List'),
                        array('Ruby', 'fas fa-gem', 'Today\'s Songs', 'This CLI executable program provides the user with top songs of the day. It collects the song data from two different sites, lists them to the user, and enables them to listen to these songs by opening the user\'s preferred song in the chrome browser.', '../pics/project_cards/Todays_songs/Capture2.PNG', 'https://github.com/danishnaseem05/todays_songs'),
                        array('Java', 'fab fa-java', 'Wave Worm', 'Wave Worm is a single player 2D Java game. The user tackles the various worms using keyboard keys, and makes his/her way across levels, while maintaining a top score.', '../pics/project_cards/Wave_worm/Capture8.PNG', 'https://github.com/danishnaseem05/Wave-Worm-Java-Game'),
                        array('Python', 'fab fa-python', 'Video and Sound Encoder', 'This gui program makes bash calls to ffmpeg in order to encode either mov (includes audio encoding from surround to stereo) or dnxhd format video(s), hence condensing their size all the while preserving quality, as well as the directory structure. And this software was made during my time interning for FCB Chicago.', '../pics/project_cards/Video_and_Sound_Encoder/Capture5.PNG', 'https://github.com/danishnaseem05/Video-and-Sound-Encoder-made-at-FCB'),
                        array('Ruby', 'fas fa-gem', 'CLI Tic Tac Toe', 'This is a CLI version of Tic Tac Toe, providing the user with single player, double player, and even zero player (meaning the player gets to watch computer vs computer) experience.', '../pics/project_cards/Tic_Tac_Toe/Capture5.PNG', 'https://github.com/danishnaseem05/CLI-Tic-Tac-Toe-Ruby')     
                    );
    
    $rows_to_add = array();
    
    $sql = "INSERT INTO project_cards(language, language_class, card_title, card_description, cover, github_url) VALUES";
