...
function resizeWindowClose(){
  var currentVPSPageOps = jQuery('.currentViewPortSize').val();
  if (currentVPSPageOps == 'rbt-l') {
    jQuery('.pb_editor_tab_content #tab1').animate({
      width:'100%',
    });
    jQuery('.pb_editor_tab_content #tab1').css({
      'float':'unset'
...
function showWidgetOpsPanel(){
  jQuery('.columnWidgetPopup').show(300);
...
jQuery(document).ready(function() {
  ...
  $('.fontfamilySearchIcon').live('click',function(){
  ...
  $('.fontSearchField').live('change',function(){
...
(function ($) {
  ...
  $('.templatesTypeFilterItem').on('click', function(){
    ...
    $('.template-card:contains("'+WidgetSearchQuery+'")').show();
      ...
      jQuery('.accordionItemsContainer').append(
        '<li>'+
          ...
          '<div class="accordContentHolder">'+
              '<label> Title  </label>'+
              '<input style="width:80%;" type="text" class="accTitle" data-optname="accordionItems.'+accordionItemsCount+'.accTitle">'+
              '<br><br><br><br><hr><br>'+
              '<textarea id="'+editorId+'"  class="accContent" data-optname="accordionItems.'+accordionItemsCount+'.accContent"></textarea>'+
          '</div>'+
        '</li>'
      );
