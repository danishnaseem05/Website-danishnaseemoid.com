<div class="pbp_form" style=" background: #fff; padding:20px 5px 20px 15px; width: 100%;">
    ...
    <div class="tabs" style="width: 100%;">
      <ul class="tab-links">
        <li class="active"><a href="#imgWidgetTab1" class="tab_link">Image</a></li>
        <li><a href="#ImgWidgetTab2" class="tab_link">Caption</a></li>
        <!-- <li><a href="#ImgWidgetTab3" class="tab_link">Hover</a></li> -->
      </ul>
        <div class="tab-content" style="box-shadow:none;">
            <div id="imgWidgetTab1" class="tab active">
            ...
            <div id="ImgWidgetTab2" class="tab">
                <br><br>
                <div class="PB_accordion" style="margin-left: -10px;">
            ...
            <div id="ImgWidgetTab3" class="tab">
