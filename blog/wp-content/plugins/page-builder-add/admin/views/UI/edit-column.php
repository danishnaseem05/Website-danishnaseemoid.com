                ...
                <div class="edit_column_widgets">
                    <div class="tabs">
                      <ul class="tab-links">
                        ...
                        <div class="tab-content" style="padding:10px 0px 15px 15px; background: #fff; min-height: 210px;">
                            ...
                            <?php
                                ...
                                if($proWidgetLoaded == false) {
                                    ?>
                                      ...
                                      <br><br><br><br><br><hr><br> <a href="https://pluginops.com/page-builder/?ref=widgets" target="_blank" style="padding:5px 10px; text-decoration: none; font-size: 17px; text-align: center; color: #fff; background:#8BC34A; border-radius: 3px;"> Unlock All These Amazing Widgets </a> <br>
                                    <?php
                                }
                            ?>
