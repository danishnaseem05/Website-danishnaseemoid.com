...
<div class="tabs" style="">
  <ul class="tab-links">
    <li class="active"><a href="#tabs_widget_cf1" class="tab_link">Items</a></li>
    <li><a href="#tabs_widget_cf2" class="tab_link">Style</a></li>
    <li><a href="#tabs_widget_cf3" class="tab_link">Icon</a></li>
  </ul>
<div class="tab-content" style="box-shadow:none;">
	<div id="tabs_widget_cf1" class="tab active" style="min-width: 380px;">
	...
	<div id="tabs_widget_cf2" class="tab" style="background: #fff; padding:10px 0; width: 99%;">
    ...
    <div id="tabs_widget_cf3" class="tab" style="background: #fff; padding:20px 10px; width: 99%;">
