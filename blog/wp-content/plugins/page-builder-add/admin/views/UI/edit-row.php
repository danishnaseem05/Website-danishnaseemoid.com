          ...
          <div id="tabPageOptions" class="tab active" style="min-height:400px;">
            <div class="tabs">
              <ul class="tab-links" style="background: #2fa8f9;">
                ...
                <li style="margin: 0;"><a href="#PocustomCSStab" class="tab_link">Custom CSS & JS</a></li>
                <!-- <li style="margin: 0;"><a href="#PocustomJStab" class="tab_link">Custom JS</a></li> -->
                <li style="margin: 0; display: none;"><a href="#PocustomFontstab" class="tab_link">Custom Fonts</a></li>
              </ul>
              <div class="tab-content" style="overflow: hidden; background: #fff;">
                  ...
                  <div class="pbp_form" style="min-height: 400px;padding:20px;">
                    ...
                    <div class="PB_accordion" style="margin-left: -10px;">
                      ...
                      <div>
                        ...
                        <div>
                          <div class="tabs">
                            <ul class="tab-links tabEditFields" style="display: none;">
                ...
                <div id="PocustomFontstab" class="tab">
