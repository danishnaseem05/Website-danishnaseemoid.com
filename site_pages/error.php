<html lang="en">
  ...
  <head>
    ...
    <title>Error | Danish Naseem</title>
  ...
  <body>
    ...
    <div id="page-container">
        ...
        <main>
            ...
            <div id= "error-page-paralax">
                <div id= "error-page-paralax-overlay">
                    <div class="container">
                        <div class="name-title">
                            <div class="row justify-content-center">
                                <div class="col-md-12 mt-5 mb-4">
                                    <h1 class="title" style="font-size: 3.8em;"><strong>reCAPTCHA Error!</strong></h1>
                                </div><!-- .column -->
                            </div><!-- .row -->
                            <div class="row justify-content-center">
                                <div class="col-md-12 mb-2">
                                    <h2 class="custom-h2">Uh oh looks like you forgot to confirm you're a human. Try Again!</h2>
                                </div><!-- .column -->
                            </div><!-- .row -->
                            <div class="row justify-content-center">
                                <div class="col-md-12">
