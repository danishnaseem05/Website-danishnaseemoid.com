  ...
  <div class="edit_form" style="width: 100% !important; overflow: hidden !important;">
      <div class="tabs" style="background: #fff;">
        <ul class="tab-links" style="background: #2fa8f9;">
          ...
          <li style="margin: 0;"><a style="font-size:12px; padding: 10px; text-align: center;" href="#tabWidgetBlocks" class="tab_link"> <i class="fab fa-pagelines" style="font-size: 20px;"></i> <br> Widget Blocks</a></li>
        </ul>
...
<div  class="editWidgetSaveButton" style="display: none;">
  <div id="editWidgetSaveVisible" data-col_id="column1"><span  class="dashicons dashicons-arrow-left editSaveVisibleIcon" data-col_id="column1"></span></div>
</div>